...
function errorTips(a, b) {
  $.colorbox({
    html:
      '<div id="uploadFile" class="popup"><table width="100%"><tr><td align="center"><h4 class="error_msg">' +
      a +
      "</h4></td>" +
      "</tr>" +
      "<tr>" +
      '<td align="center"><a href="#" class="btn_s">&nbsp;定</a></td>' +
      "</tr>" +
      "</table>" +
      "</div>",
    title: b ? b : "",
...
$(function () {
  $("#email,#password").blur(function () {
    ...
    $(".collapsible_menu").hover(
      function () {
        $(this).addClass("expend"), $("dd", this).show();
      },
      function () {
        $(this).removeClass("expend"), $("dd", this).hide();
      }
    ),
    ...
    $(document).click(function () {
      $("#box_expectCity").hide(),
        $("#workplaceSelect .more")
          .removeClass("open")
          .children(".citymore_arrow")
