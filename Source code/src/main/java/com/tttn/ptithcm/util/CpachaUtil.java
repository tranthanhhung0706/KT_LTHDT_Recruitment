...
public class CpachaUtil {
	...
	final private String[] fontNames = new String[]{"Arial", 
...
/**
* Kích thước phông chữ hình ảnh mã xác minh
* Mặc định 17
*/
	private int fontsize = 21;
	/**
	 *Mã xác minh chiều rộng hình ảnh
	 */
	private int width = (fontsize+1)*vcodeLen+10;
	/**
	 * Mã xác minh chiều cao hình ảnh
	 */
	private int height = fontsize+12;
	/**
	 * Số lượng đường giao thoa
* Theo mặc định 3
	 */
	...
	public BufferedImage generatorVCodeImage(String vcode, boolean drawline){
		...
		//Được sử dụng để tạo số giả giả
		Random ran = new Random();
		//Vẽ mã xác minh trên hình
		...
		//Phát hành bối cảnh của đồ họa này và tất cả các tài nguyên hệ thống mà nó sử dụng
		g.dispose();
