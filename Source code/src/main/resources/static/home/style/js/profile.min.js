function scoreChange(a) {
  function e() {
    ...
    new Chart(b).Doughnut(c, d),
      ...
      100 == a
        ? $("#resumeScore .which span").html(
            '<a href="/home/position/list">Tiếp tục ứng tuyển công việc</a>'
          )
        : $("#resumeScore .which span").html("<a>Chưa thể ứng tuyển công việc</a>");
  }
  var b = (360 * parseInt(a)) / 100,
    c = [
      { value: b, color: "#009a6d" },
      { value: 360 - b, color: "#ffffff" },
    ],
    d = {
...
function changeAllIds(a) {
  ...
  $("#resumeId").val(b.resumeId.n),
    ...
    (e = b.projectId),
    (f = b.showId),
    $("#workExperience .wlist li").each(function () {
      var b,
        a = $(this).attr("data-id");
      for (b = 0; b < c.length; b++)
        a == c[b].o && $(this).attr("data-id", c[b].n);
    }),
    $("#projectExperience .plist li").each(function () {
      var b,
        a = $(this).attr("data-id");
      for (b = 0; b < e.length; b++)
        a == e[b].o && $(this).attr("data-id", e[b].n);
    }),
    $("#educationalBackground .elist li").each(function () {
      var b,
        a = $(this).attr("data-id");
      for (b = 0; b < d.length; b++)
        a == d[b].o && $(this).attr("data-id", d[b].n);
    }),
    $("#worksShow .slist li").each(function () {
      var b,
        a = $(this).attr("data-id");
      for (b = 0; b < f.length; b++)
        a == f[b].o && $(this).attr("data-id", f[b].n);
    });
}
function openYear(a) {
...
function file_check(obj, action_url, id) {
  ...
  $("#loadingImg").css("visibility", "visible"),
    ...
    0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt)
      ? (errorTips("word、pdf、ppt、txt、wps"),
            ...
            $("#loadingImg").css("visibility", "hidden"),
              json.success
                ? ((html =
                    '<a href="' +
                    ctx +
                    '/nearBy/downloadResume" class="resume_download" title="' +
                    json.content.nearbyName +
                    '">' +
                    json.content.nearbyName +
                    "</a>" +
                    '<a  class="fr del" href="javascript:;">xóa bỏ</a><br /><span class="c9">：' +
                    json.content.time +
                    "</span>"),
                  $("#myResume .resumeUploadDiv").html(html),
                  $("#myResume h2 a").html(""),
                  $.colorbox({
                    inline: !0,
                    href: $("div#uploadFileSuccess"),
                    title: "Tải lên sơ yếu lý lịch",
                  }))
                : -1 == json.code
                ? $.colorbox({
                    inline: !0,
                    href: $("div#fileResumeUpload"),
                    title: "Tải lên sơ yếu lý lịch tải lên không thành công",
                  })
                : -2 == json.code
                ? $.colorbox({
                    inline: !0,
                ...
                : (errorTips("Tiếp tục tải lên không thành công, vui lòng tải lên lại"),
                  $("#loadingImg").css("visibility", "hidden"));
          },
          error: function () {
            errorTips("Tiếp tục tải lên không thành công, vui lòng tải lên lại"),
  ...
  function d(b) {
    ...
    return (
      ...
      o(h, function (a, e) {
        ...
        return h
          ? ((f = c[i](h)),
            (c[j[i].cache] = f[j[i].cache]),
            (d = c._rgba = f._rgba),
            !1)
          : void 0;
      }),
      d.length
        ? ("0,0,0,0" === d.join() && a.extend(d, n.transparent), c)
        : n[b]
    );
  }
  function e(a, b, c) {
    ...
    (i.fn = a.extend(i.prototype, {
      parse: function (e, f, g, h) {
        ...
        var k = this,
          ...
          m = (this._rgba = []);
        return (
          f !== b && ((e = [e, f, g, h]), (l = "array")),
          "string" === l
            ? this.parse(d(e) || n._default)
            : "array" === l
            ? (o(j.rgba.props, function (a, b) {
                m[b.idx] = c(e[b.idx], b);
              }),
              this)
            : "object" === l
            ? (e instanceof i
                ...
                : o(j, function (b, d) {
                    ...
                    o(d.props, function (a, b) {
                      ...
                      k[f] &&
                        a.inArray(null, k[f].slice(0, 3)) < 0 &&
                        ((k[f][3] = 1), d.from && (k._rgba = d.from(k[f])));
                  }),
              this)
            : void 0
        );
        ...
        o(f, function (b, c) {
          i.fn[b] ||
            (i.fn[b] = function (e) {
              ...
              return "undefined" === f
                ? j
                : ("function" === f && ((e = e.call(this, j)), (f = a.type(e))),
                  null == e && c.empty
                    ? this
                    : ("string" === f &&
                        ((k = g.exec(e)),
                        k &&
                          (e = j + parseFloat(k[2]) * ("+" === k[1] ? 1 : -1))),
                      (i[c.idx] = e),
                      this[h](i)));
            });
        });
  ...
  $(function () {
      ...
      $(".projectForm").each(function () {
        $(this).validate({
          ...
          errorPlacement: function (a, b) {
            "projectYearStart" == b.attr("name") ||
            "projectMonthStart" == b.attr("name") ||
            "projectYearEnd" == b.attr("name") ||
            "projectMonthEnd" == b.attr("name")
          ...
          submitHandler: function (a) {
            var b = $('input[name="projectName"]', a).val(),
              ...
              i =
                "项目描述" != $('textarea[name="projectDescription"]', a).val()
                  ? $('textarea[name="projectDescription"]', a).val()
                  : "",
              j = $(".projectId", a).val(),
              l = $("#resumeId").val(),
              m = $("#resubmitToken").val();
            $(a).find(":submit").val("保存中...").attr("disabled", !0),
              $.ajax({
                ...
                $("#resubmitToken").val(b.resubmitToken),
                  b.success
                    ? ((c = b.content.projectExperience),
                      (e = ""),
                      3 == b.code
                        ? "" != c
                          ? ((e += '<li data-id="' + c.id + '">'),
                            (e +=
                              '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' +
                              c.projectName +
                              '" data-posName="' +
                              c.positionName +
                              '" data-startY="' +
                            ...
                            "" !=
                              $.trim(
                                d.obj
                                  .children(".projectShow")
                                  .children(".plist")
                                  .html()
                              ) && $(a).remove(),
                            d.obj.children(".c_add").removeClass("dn"),
                            d.obj
                              .children(".projectShow")
                              .children(".plist")
                              .prepend(e),
                            d.obj.children(".projectShow").removeClass("dn"),
                            d.obj.children(".projectEdit").addClass("dn"))
                          : "" !=
                            $.trim(
                              d.obj
                                .children(".projectShow")
                          ...
                          ? ($(a).remove(),
                            d.obj.children(".c_add").removeClass("dn"))
                          : (d.obj.children(".projectEdit").addClass("dn"),
                            d.obj.children(".projectAdd").removeClass("dn"))
                        : 4 == b.code
                        ? ((e +=
                            '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' +
                            c.projectName +
                          ...
                          "" != c.projectRemark &&
                            (e +=
                              '<div class="dl1">' + c.projectRemark + "</div>"),
                          (e += "</div>"),
                          $(a).parent("li").html(e))
                        : 2 == b.code &&
                          ($(a).parent("li").remove(),
    ...
    function i() {
      $(".workForm").each(function () {
        $(this).validate({
          ...
          messages: {
            workLink: {},
            workDescription: { maxlength: "" },
          },
          submitHandler: function (a) {
            var b =
                "" != $('input[name="workLink"]', a).val()
                  ? $('input[name="workLink"]', a).val()
                  : "",
              c =
                "" !=
                $('textarea[name="workDescription"]', a).val()
                  ? $('textarea[name="workDescription"]', a).val()
                  : "",
              d = $(".showId", a).val(),
              e = $("#resumeId").val(),
              f = $("#resubmitToken").val();
            $(a).find(":submit").val("").attr("disabled", !0),
              $.ajax({
                      ...
                      3 == b.code
                        ? "" != e
                          ? ((c +=
                            ...
                            e.url &&
                              ((d =
                                "http://" == e.url.substring(0, 7) ||
                                "https://" == e.url.substring(0, 8)
                                  ? e.url
                                  : "http://" + e.url),
                              (c +=
                                '<div class="f16">：<a href="' +
                                d +
                                '" target="_blank">' +
                                e.url +
                                "</a></div>")),
                            (c += "<p>" + e.workName + "</p>" + "</div></li>"),
                            placeholderFn(),
                            "" !=
                              $.trim(
                                h.obj
                            ...
                            h.obj
                              ...
                              .children(".slist")
                              .prepend(c),
                            h.obj.children(".workShow").removeClass("dn"),
                            h.obj.children(".workEdit").addClass("dn"),
                            h.obj.children(".c_add").removeClass("dn"))
                          : "" !=
                            $.trim(
                              h.obj
                                .children(".workShow")
                          ...
                          ? ($(a).remove(),
                            h.obj.children(".c_add").removeClass("dn"))
                          : (h.obj.children(".workEdit").addClass("dn"),
                            h.obj.children(".workAdd").removeClass("dn"))
                        : 4 == b.code
                        ? ((c +=
                            '<div class="workList c7"><i class="sm_del dn"></i><i class="sm_edit dn"></i>'),
                          e.url &&
                            ((d =
                              "http://" == e.url.substring(0, 7) ||
                              "https://" == e.url.substring(0, 8)
    ...
    $(".profile_radio li input").click(function () {
      ...
      $("#resumeScore .which span").bind("click", function () {
        window.location.href = "/home/position/list";
      }),
      ...
      $("#resumeNameForm").validate({
        ...
        submitHandler: function (a) {
          var b = $('input[name="resumeName"]', a).val(),
            c = $("#resumeId").val();
          $(a).find(":submit").attr("disabled", !0),
            $.ajax({
              ...
              if (b.success) {
                var c = "";
                (c =
                  b.content.resumeName.length > 18
                    ? b.content.resumeName.substring(0, 15) + "..."
                    : b.content.resumeName),
                  $("#resume_name .nameShow h1")
                    .attr("title", b.content.resumeName)
                    .text(c)
                    .parent()
                    .removeClass("dn"),
      ...
      $("#basicInfo .c_edit").bind("click", function () {
        var a = $("#nameVal").val(),
          ...
          g = $("#telVal").val();
        $("#name").val(a),
          $('#basicInfo .profile_radio li input[value="' + b + '"]')
            .attr("checked", !0)
            .parent("li")
            .addClass("current")
            .siblings("li")
          ...
          "" != e &&
            ($("#currentState").val(e),
            $("#select_currentState").val(e).css("color", "#333")),
          $("#email").val(f),
          $("#tel").val(g),
          $("#portraitShow img").attr(
            "src",
            $("#basicInfo .basicShow img").attr("src")
          ),
          $("#portraitNo").hide(),
          $("#portraitShow").show(),
          $(this).addClass("dn"),
      ...
      $("#profileForm").validate({
        rules: {
          gender: { required: !1 },
          topDegree: { required: !0 },
          workyear: { required: !0 },
          currentState: { required: !1 },
        ...
        errorPlacement: function (a, b) {
          "hidden" == b.attr("type")
            ? a.appendTo($(b).parent())
            : "radio" == b.attr("type")
            ? a.insertAfter($(b).parents("ul"))
            : a.insertAfter(b);
        },
        submitHandler: function (a) {
          var b = $('input[name="name"]', a).val(),
            c = $('input[name="gender"]:checked', a).val(),
            d = $('input[name="topDegree"]', a).val(),
            e = $('input[name="workyear"]', a).val(),
            f = $('input[name="currentState"]', a).val(),
            g = $('input[name="email"]', a).val(),
            h = $('input[name="tel"]', a).val(),
            i = $("#pageType").val(),
            j = $("#resumeId").val(),
            l = $("#resubmitToken").val();
          $(a).find(":submit").val("保存中...").attr("disabled", !0),
            $.ajax({
              ...
              $("#resubmitToken").val(b.resubmitToken),
                b.success
                  ? "/resume/myresume.html" == b.content.url
                    ? (window.location.href = ctx + b.content.url)
                    : ((c = b.content.resume),
                      (d = c.workYear),
                      "" != d
                        ? ((d += ""),
                      ...
                      (e +=
                        ...
                        "<br />" +
                        c.status),
                      $(".collapsible_menu dt").html(c.name + "<i></i>"),
                      $("#basicInfo .basicShow span")
                        .html(e)
                        .parent()
                        .removeClass("dn"),
                      ...
                      $("#nameVal").val(c.name),
                      $("#genderVal").val(c.sex),
                      $("#topDegreeVal").val(c.highestEducation),
                      $("#workyearVal").val(c.workYear),
                      $("#currentStateVal").val(c.status),
                      $("#emailVal").val(c.email),
                      $("#telVal").val(c.phone),
                      $("#lastChangedTime span").text(b.content.refreshTime),
                      b.content.isNew && changeAllIds(b.content.jsonIds),
                      scoreChange(b.content.infoCompleteStatus.score),
          ...
          "" == this.expectCityVal
            ? ($("#expectCity").val(""),
              $("#select_expectCity")
                .val("")
                .css("color", "#999"))
            : ($("#expectCity").val(this.expectCityVal),
              $("#select_expectCity")
                .val(this.expectCityVal)
                .css("color", "#333")),
            "" != this.typeVal
              ? $(
                  '#expectJob .profile_radio li input[value="' +
                    this.typeVal +
                    '"]'
                )
                  .attr("checked", !0)
                  ...
                  .siblings("li")
                  .removeClass("current")
              : $("#expectJob .profile_radio li input")
                  .attr("checked", !1)
                  .parent("li")
                  .removeClass("current"),
            $("#expectPosition").val(this.expectPositionVal),
            "" == this.expectSalaryVal
              ? ($("#expectSalary").val(""),
                $("#select_expectSalary").val("").css("color", "#999"))
              : ($("#expectSalary").val(this.expectSalaryVal),
                $("#select_expectSalary")
                  .val(this.expectSalaryVal)
                  .css("color", "#333")),
            placeholderFn(),
            this.obj.find(".expectAdd").addClass("dn"),
            this.obj.find(".expectShow").addClass("dn"),
      ...
      $("#expectForm").validate({
        ...
        submitHandler: function (a) {
          var c = $('input[name="expectCity"]', a).val(),
            d = $('input[name="type"]:checked', a).val(),
            e =
              "" !=
              $('input[name="expectPosition"]', a).val()
                ? $('input[name="expectPosition"]', a).val()
                : "",
            f = $('input[name="expectSalary"]', a).val(),
            g = $("#resumeId").val(),
            h = $("#resubmitToken").val();
          $(a).find(":submit").val("").attr("disabled", !0),
            $.ajax({
              ...
              if (($("#resubmitToken").val(g.resubmitToken), g.success)) {
                if (c || d || e || f) {
                  ...
                  b.obj
                    ...
                    .parent()
                    .removeClass("dn"),
                    b.obj.find(".c_edit").removeClass("dn"),
                    b.obj.find(".expectEdit").addClass("dn"),
                    b.obj.find("#expectJobVal").val(g.content.resume.expectJob),
                    b.obj.find("#expectCityVal").val(g.content.resume.city),
                    b.obj.find("#typeVal").val(g.content.resume.positionType),
                    b.obj
                      .find("#expectPositionVal")
                      .val(g.content.resume.positionName),
                    b.obj
                      .find("#expectSalaryVal")
                      .val(g.content.resume.salarys),
                    (b.expectJobVal = g.content.resume.expectJob),
                    (b.expectCityVal = g.content.resume.city),
                    (b.typeVal = g.content.resume.positionType),
                    (b.expectPositionVal = g.content.resume.positionName),
                    (b.expectSalaryVal = g.content.resume.salarys),
                    $("#lastChangedTime span").text(g.content.refreshTime),
                    $("#resumeScore .which div").text(
                      g.content.infoCompleteStatus.msg
                    ),
                    $("#resumeScore .which span").attr(
                      "rel",
                      "/home/position/list"
                    ),
                    scoreChange(g.content.infoCompleteStatus.score),
                    k(b.obj);
                } else
                  b.obj.find(".expectShow").addClass("dn"),
                    b.obj.find(".expectEdit").addClass("dn"),
                    b.obj.find(".c_edit").addClass("dn"),
                    b.obj.find(".expectAdd").removeClass("dn"),
                    k(b.obj);
      ...
      $(".box_companyYearStart").on("click", "ul li", function (a) {
        ...
        a.stopPropagation(),
          (b = $(this).text()),
          selectYear("companyYearStart", b),
          (c = $(this).parents(".experienceForm")),
          $(this)
            .parents(".box_companyYearStart")
            .siblings(".companyYearStart")
            .hasClass("error") &&
            $(this)
              .parents(".experienceForm")
              .validate()
              .element(c.find(".companyYearStart")),
          c.find(".companyYearEnd").hasClass("error")
            ? $(this)
                .parents(".experienceForm")
                .validate()
                .element(c.find(".companyYearEnd"))
            : c.find(".companyMonthEnd").hasClass("error") &&
              $(this)
                .parents(".experienceForm")
                .validate()
      ...
      $(".box_companyMonthStart").on("click", "ul li", function (a) {
        ...
        a.stopPropagation(),
          (b = $(this).text()),
          selectYear("companyMonthStart", b),
          (c = $(this).parents(".experienceForm")),
          $(this)
            .parents(".box_companyMonthStart")
            .siblings(".companyMonthStart")
            .hasClass("error") &&
            $(this)
              .parents(".experienceForm")
              .validate()
      ...
      $(".box_companyYearEnd").on("click", "ul li", function (a) {
        ...
        a.stopPropagation(),
          ...
          (c = $(this)
            .parents(".experienceForm")
            .find(".companyMonthEnd")
            .val()),
          selectYear("companyYearEnd", b),
          (d = $(this).parents(".experienceForm")),
          "" == $.trim(b)
            ? (d.find(".companyMonthEnd").val(""),
              d
                .find(".select_companyMonthEnd")
                .css("color", "#333")
                .val(""),
              d.find(".select_companyMonthEnd").unbind("click"))
            : ("" == $.trim(c) &&
                (d.find(".companyMonthEnd").val(""),
                d
                  .find(".select_companyMonthEnd")
                  .css("color", "#999")
                  .val("")),
              d.find(".select_companyMonthEnd").bind("click", function (a) {
                a.stopPropagation(), openYear("companyMonthEnd");
              })),
          $(this)
            .parents(".box_companyYearEnd")
            .siblings(".companyYearEnd")
            .hasClass("error") &&
            $(this)
              .parents(".experienceForm")
              .validate()
              .element(d.find(".companyYearEnd")),
          d.find(".companyYearStart").hasClass("error")
            ? $(this)
                .parents(".experienceForm")
                .validate()
                .element(d.find(".companyYearStart"))
            : d.find(".companyMonthStart").hasClass("error") &&
              $(this)
                .parents(".experienceForm")
                .validate()
      ...
      $(".box_companyMonthEnd").on("click", "ul li", function (a) {
        ...
        a.stopPropagation(),
          (b = $(this).text()),
          selectYear("companyMonthEnd", b),
          (c = $(this).parents(".experienceForm")),
          $(this)
            .parents(".box_companyMonthEnd")
            .siblings(".companyMonthEnd")
            .hasClass("error") &&
            $(this)
              .parents(".experienceForm")
              .validate()
              .element(c.find(".companyMonthEnd")),
          c.find(".companyYearStart").hasClass("error")
            ? $(this)
                .parents(".experienceForm")
                .validate()
                .element(c.find(".companyYearStart"))
            : c.find(".companyMonthStart").hasClass("error") &&
              $(this)
                .parents(".experienceForm")
                .validate()
                .element(c.find(".companyMonthStart"));
      ...
      (c = {
        ...
        Add: function () {
          this.obj.children(".experienceEdit").find(".companyName").val(""),
            ...
            this.obj
              .children(".experienceEdit")
              .find(".companyYearStart")
              .val(""),
            this.obj
              .children(".experienceEdit")
              .find(".select_companyYearStart")
              .css("color", "#999"),
            this.obj.children(".experienceEdit").find(".companyMonthStart"),
            this.obj
              .children(".experienceEdit")
              .find(".select_companyMonthStart")
              .css("color", "#999"),
            this.obj.children(".experienceEdit").find(".companyYearEnd"),
            this.obj
              .children(".experienceEdit")
              .find(".select_companyYearEnd")
              .css("color", "#999"),
            this.obj.children(".experienceEdit").find(".companyMonthEnd"),
            this.obj
              .children(".experienceEdit")
              .find(".select_companyMonthEnd")
              .css("color", "#999"),
        ...
        AddMore: function () {
          this.obj.children(".experienceShow").find(".companyName").val(""),
            ...
            this.obj
              ...
              .find(".select_companyYearStart")
              .css("color", "#999"),
            this.obj.children(".experienceShow").find(".companyMonthStart"),
            this.obj
              .children(".experienceShow")
              .find(".select_companyMonthStart")
              .css("color", "#999"),
            this.obj.children(".experienceShow").find(".companyYearEnd"),
            this.obj
              .children(".experienceShow")
              .find(".select_companyYearEnd")
              .css("color", "#999"),
            this.obj.children(".experienceShow").find(".companyMonthEnd"),
            this.obj
              .children(".experienceShow")
              .find(".select_companyMonthEnd")
              .css("color", "#999"),
        ...
        Del: function (a) {
          ...
          $.ajax({
            ...
            b.success
              ? (a.parent("li").remove(),
                "" == b.content.workExperiences ||
                null == b.content.workExperiences
                  ? (c.obj.children(".experienceShow").addClass("dn"),
                    c.obj.children(".experienceEdit").addClass("dn"),
                    c.obj.children(".experienceAdd").removeClass("dn"),
                    c.obj.children(".c_add").addClass("dn"))
                  : c.obj
                      .children(".experienceShow")
                      .children(".experienceForm")
                      .hide(),
      ...
      c.obj.on("click", ".sm_del", function () {
        confirm("Bạn có muốn xóa nó không?") && c.Del($(this));
      }),
      ...
      c.obj.delegate(".companyName", "keyup", function () {
        var a = $.trim($(this).val());
        "" != a && suggestCompany(a, ".companyName");
      }),
      c.obj.delegate(".positionName", "keyup", function () {
        var a = $.trim($(this).val());
      ...
      $(".experienceForm").each(function () {
        $(this).validate({
          ...
          companyMonthEnd: {},
          errorPlacement: function (a, b) {
            "companyYearStart" == b.attr("name") ||
            "companyMonthStart" == b.attr("name") ||
            "companyYearEnd" == b.attr("name") ||
            "companyMonthEnd" == b.attr("name")
              ? a.appendTo($(b).parent().parent())
              : a.insertAfter(b);
          },
          submitHandler: function (a) {
            ...
            $(a).find(":submit").val("...").attr("disabled", !0),
              $.ajax({
                ...
                if (($("#resubmitToken").val(b.resubmitToken), b.success)) {
                  for (
                    d = b.content.workExperiences, e = "", f = 0;
                    f < d.length;
                    f++
                  )
                    (e +=
                      0 == f % 2
                        ? '<li data-id="' + d[f].id + '" class="clear">'
                        : '<li data-id="' + d[f].id + '">'),
                      (e +=
                        '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startYear="' +
                        d[f].startYear +
                        '" data-endYear="' +
                        d[f].endYear +
                        '" data-startMonth = "' +
      ...
      $("#projectExperience").on(
        "click",
        ".select_projectYearStart",
        function (a) {
          a.stopPropagation(),
            $(".profile_select_normal").removeClass("select_focus"),
            $(".boxUpDown").hide(),
      ...
      $("#projectExperience").on(
        "click",
        ".box_projectYearStart li",
        function (a) {
          var b, c;
          a.stopPropagation(),
            (b = $(this).text()),
            $(this)
              .parents(".box_projectYearStart")
              .siblings(".select_projectYearStart")
              .val(b)
              .css("color", "#333")
              .removeClass("select_focus"),
            $(this)
              .parents(".box_projectYearStart")
              .siblings(".projectYearStart")
              .val(b),
            ...
            $(this)
              ...
              $(this)
                .parents(".projectForm")
                .validate()
                .element(c.find(".projectYearStart")),
            c.find(".projectYearEnd").hasClass("error")
              ? $(this)
                  .parents(".projectForm")
                  .validate()
                  .element(c.find(".projectYearEnd"))
              : c.find(".projectMonthEnd").hasClass("error") &&
                $(this)
                  .parents(".projectForm")
                  .validate()
                  .element(c.find(".projectMonthEnd"));
        }
      ),
      $("#projectExperience").on(
        "click",
        ".select_projectMonthStart",
        function (a) {
          a.stopPropagation(),
            $(".profile_select_normal").removeClass("select_focus"),
            $(".boxUpDown").hide(),
            $(this).addClass("select_focus"),
            $(this).siblings(".box_projectMonthStart").show();
        }
      ),
      $("#projectExperience").on(
        "click",
        ".box_projectMonthStart li",
        function (a) {
          var b, c;
          a.stopPropagation(),
            (b = $(this).text()),
            $(this)
              .parents(".box_projectMonthStart")
              .siblings(".select_projectMonthStart")
              .val(b)
              .css("color", "#333")
              .removeClass("select_focus"),
            $(this)
              .parents(".box_projectMonthStart")
              .siblings(".projectMonthStart")
              .val(b),
            $(this).parents(".box_projectMonthStart").hide(),
            (c = $(this).parents(".projectForm")),
            $(this)
              .parents(".box_projectMonthStart")
              .siblings(".projectMonthStart")
              ...
              $(this)
                .parents(".projectForm")
                .validate()
                .element(c.find(".projectMonthStart")),
            c.find(".projectYearEnd").hasClass("error")
              ? $(this)
                  .parents(".projectForm")
                  .validate()
      ...
      $("#projectExperience").on(
        "click",
        ".select_projectYearEnd",
        function (a) {
          a.stopPropagation(),
            $(".profile_select_normal").removeClass("select_focus"),
            $(".boxUpDown").hide(),
            $(this).addClass("select_focus"),
            $(this).siblings(".box_projectYearEnd").show();
        }
      ),
      $("#projectExperience").on(
        "click",
        ".box_projectYearEnd li",
        function (a) {
          var b, c, d;
          a.stopPropagation(),
            (b = $(this).text()),
            ...
            $(this)
              .parents(".box_projectYearEnd")
              .siblings(".projectYearEnd")
              .val(b),
            $(this).parents(".box_projectYearEnd").hide(),
            (d = $(this).parents(".projectForm")),
            "" == $.trim(b)
              ? (d.find(".projectMonthEnd").val(""),
                d
                  .find(".select_projectMonthEnd")
                  .css("color", "#333")
                  .val(""),
                $("#projectExperience").off("click", ".select_projectMonthEnd"))
              : ("" == $.trim(c) &&
                  (d.find(".projectMonthEnd").val(""),
                  d
                    .find(".select_projectMonthEnd")
                ...
                $("#projectExperience").on(
                  "click",
                  ".select_projectMonthEnd",
                  function (a) {
                    a.stopPropagation(),
                      $(".profile_select_normal").removeClass("select_focus"),
                      $(".boxUpDown").hide(),
                      $(this).addClass("select_focus"),
                      $(this).siblings(".box_projectMonthEnd").show();
                  }
                )),
            $(this)
              .parents(".box_projectYearEnd")
              ...
              $(this)
                .parents(".projectForm")
                .validate()
                .element(d.find(".projectYearEnd")),
            d.find(".projectYearStart").hasClass("error")
              ? $(this)
                  .parents(".projectForm")
                  .validate()
                  .element(d.find(".projectYearStart"))
              : d.find(".projectMonthStart").hasClass("error") &&
                $(this)
                  .parents(".projectForm")
                  .validate()
                  .element(d.find(".projectMonthStart"));
        }
      ),
      $("#projectExperience").on(
        "click",
      ...
      $("#projectExperience").on(
        ...
        function (a) {
          ...
          a.stopPropagation(),
            ...
            $(this)
              .parents(".box_projectMonthEnd")
              .siblings(".projectMonthEnd")
              .val(b),
            $(this).parents(".box_projectMonthEnd").hide(),
            (c = $(this).parents(".projectForm")),
            $(this)
              .parents(".box_projectMonthEnd")
              .siblings(".projectMonthEnd")
              ...
              $(this)
                ...
                .validate()
                .element(c.find(".projectMonthEnd")),
            c.find(".projectYearStart").hasClass("error")
              ? $(this)
                  .parents(".projectForm")
                  .validate()
                  .element(c.find(".projectYearStart"))
              : c.find(".projectMonthStart").hasClass("error") &&
                $(this)
                  .parents(".projectForm")
                  .validate()
                  .element(c.find(".projectMonthStart"));
      ...
      (d = {
        ...
        resetForm: function () {
          this.obj.children(".projectEdit").find(".projectName"),
            this.obj.children(".projectEdit").find(".thePost"),
            this.obj.children(".projectEdit").find(".projectYearStart"),
            this.obj
              .children(".projectEdit")
              .find(".select_projectYearStart")
              .css("color", "#999"),
            this.obj.children(".projectEdit").find(".projectMonthStart"),
            this.obj
              .children(".projectEdit")
              .find(".select_projectMonthStart")
              .css("color", "#999"),
            this.obj.children(".projectEdit").find(".projectYearEnd"),
            this.obj
              .children(".projectEdit")
              .find(".select_projectYearEnd")
              .css("color", "#999"),
            this.obj.children(".projectEdit").find(".projectMonthEnd"),
            this.obj
              .children(".projectEdit")
              .find(".select_projectMonthEnd")
              .css("color", "#999"),
            this.obj.children(".projectEdit").find(".projectDescription"),
            this.obj
              .children(".projectEdit")
              .find(".word_count")
              .children("span")
        ...
        AddMore: function () {
          this.resetForm(),
            ...
            this.obj
              .children(".projectShow")
              .prepend(
                this.obj.children(".projectEdit").children("form").clone()
              ),
            this.obj
              .children(".projectShow")
              .children("form")
        ...
        Edit: function (a) {
          ...
          l && (l = $.trim(l.replace(/<br>/gi, ""))),
            ...
            "" != g &&
              (m.find(".projectYearStart").val(g),
              m.find(".select_projectYearStart").css("color", "#333").val(g)),
            "" != h &&
              (m.find(".projectMonthStart").val(h),
              m.find(".select_projectMonthStart").css("color", "#333").val(h)),
            "" != i &&
              (m.find(".projectYearEnd").val(i),
              m.find(".select_projectYearEnd").css("color", "#333").val(i)),
            "" != k &&
              (m.find(".projectMonthEnd").val(k),
              m.find(".select_projectMonthEnd").css("color", "#333").val(k)),
            "" == $.trim(k) &&
              m.find(".select_projectMonthEnd").unbind("click"),
            m.find(".projectDescription").val(l),
            m
              .find(".word_count")
              .children("span")
              .text(500 - m.find(".projectDescription").val().length),
          ...
          $.ajax({
            ...
            b.success
              ? (a.parents("li").remove(),
                ...
                ("" == b.content.projectExperiences ||
                  null == b.content.projectExperiences) &&
                  (d.obj.children(".projectShow").addClass("dn"),
                  d.obj.children(".projectEdit").addClass("dn"),
                  d.obj.children(".projectAdd").removeClass("dn"),
                  d.obj.children(".c_add").addClass("dn")),
                $("#lastChangedTime span").text(b.content.refreshTime),
                $("#resumeScore .which div").text(
                  b.content.infoCompleteStatus.msg
                ),
      ...
      d.obj.on("keyup", ".s_textarea", function () {
        var a = $(this);
        $.trim(a.val()).length > 500
          ? a.val($.trim(a.val()).substring(0, 500))
          : a
              .next(".word_count")
              .children("span")
              .text(500 - $.trim(a.val()).length);
      }),
      d.obj
        .children(".projectEdit")
        .find(".btn_profile_cancel")
      ...
      d.obj
        .children(".projectShow")
        .on("click", ".btn_profile_cancel", function () {
      ...
      $(".box_schoolYearStart").on("click", "ul li", function (a) {
        ...
        selectYear("schoolYearStart", b),
          $(this)
            .parents(".educationalForm")
            .validate()
            .element($(".schoolYearStart"));
      }),
      ...
      (f = {
        ...
        Add: function () {
          this.obj.children(".educationalEdit").find(".schoolName").val(""),
            ...
            this.obj
              .children(".educationalEdit")
              .find(".select_degree")
              .css("color", "#999"),
            this.obj
              .children(".educationalEdit")
              .find(".professionalName")
              .val(""),
            this.obj.children(".educationalEdit").find(".schoolYearStart"),
            this.obj
              .children(".educationalEdit")
              .find(".select_schoolYearStart")
              .css("color", "#999"),
            this.obj.children(".educationalEdit").find(".schoolYearEnd"),
            this.obj
              .children(".educationalEdit")
              .find(".select_schoolYearEnd")
              .css("color", "#999"),
            placeholderFn(),
        ...
        Del: function (a) {
          ...
          $.ajax({
            ...
            b.success
              ? (a.parent("li").remove(),
                "" == b.content.educationExperiences ||
                null == b.content.educationExperiences
                  ? (f.obj.children(".educationalShow").addClass("dn"),
                    f.obj.children(".educationalEdit").addClass("dn"),
                    f.obj.children(".educationalAdd").removeClass("dn"),
                    f.obj.children(".c_add").addClass("dn"))
                  : f.obj
                      .children(".educationalShow")
                      .children(".educationalForm")
                      .hide(),
      ...
      $(".educationalForm").each(function () {
        $(this).validate({
          ...
          errorPlacement: function (a, b) {
            "hidden" == b.attr("type")
              ? "schoolYearStart" == b.attr("name") ||
                "schoolYearEnd" == b.attr("name")
                ? a.appendTo($(b).parent().parent())
                : a.appendTo($(b).parent())
              : a.insertAfter(b);
          },
          submitHandler: function (a) {
            ...
            $(a).find(":submit").val("...").attr("disabled", !0),
              $.ajax({
                ...
                if (($("#resubmitToken").val(b.resubmitToken), b.success)) {
                  for (
                    c = b.content.educationExperiences, d = "", e = 0;
                    e < c.length;
                    e++
                  )
                    (d +=
                      0 == e % 2
                        ? '<li data-id="' + c[e].id + '" class="clear">'
                        : '<li data-id="' + c[e].id + '">'),
                      (d +=
                        '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startY="' +
                        c[e].startDate +
                        '" data-endY="' +
                        c[e].endDate +
                        '">' +
      ...
      (g = {
        ...
        Add: function () {
          this.obj
            .children(".descriptionEdit")
            .find(".selfDescription")
            .val(""),
        ...
        Cancel: function () {
          this.text
            ? (this.obj.children(".descriptionAdd").addClass("dn"),
              this.obj.children(".descriptionShow").removeClass("dn"),
              this.obj.children(".descriptionEdit").addClass("dn"),
              this.obj.children(".c_edit").removeClass("dn"))
            : (this.obj.children(".descriptionAdd").removeClass("dn"),
              this.obj.children(".descriptionShow").addClass("dn"),
              this.obj.children(".descriptionEdit").addClass("dn")),
            k(this.obj);
        },
      ...
      $(".descriptionForm").validate({
        rules: { selfDescription: { required: !1 } },
        submitHandler: function (a) {
                ...
                b.success
                  ? ((c = b.content.resume),
                    ...
                    c.myRemark
                      ? ((d = c.myRemark),
                        (g.text = c.myRemark),
                        g.obj.children(".c_edit").removeClass("dn"),
                        g.obj
                          .children(".descriptionShow")
                          .html(d)
                          .removeClass("dn"),
                        g.obj.children(".descriptionEdit").addClass("dn"),
                        $("#lastChangedTime span").text(b.content.refreshTime),
                        $("#resumeScore .which div").text(
                          b.content.infoCompleteStatus.msg
                        ),
                        ...
                        k(g.obj))
                      : ((g.text = ""),
                        g.obj.children(".c_edit").addClass("dn"),
                        g.obj.children(".descriptionShow").addClass("dn"),
                        g.obj.children(".descriptionEdit").addClass("dn"),
      ...
      (h = {
        ...
        AddMore: function () {
          this.resetForm(),
            this.obj
              .children(".workShow")
              .prepend(this.obj.children(".workEdit").children("form").clone()),
        ...
        Edit: function (a) {
          ...
          e && (e = $.trim(e.replace(/<br>/gi, ""))),
            ...
            f
              .find(".word_count")
              .children("span")
              .text(100 - f.find(".workDescription").val().length),
            f.find(".showId").val(c),
        ...
        Del: function (a) {
          ...
          $.ajax({
            ...
            b.success
              ? (a.parents("li").remove(),
                $("ul.slist li:last-child").addClass("noborder"),
                ("" == b.content.workShows || null == b.content.workShows) &&
                  (h.obj.children(".workShow").addClass("dn"),
                  h.obj.children(".workEdit").addClass("dn"),
                  h.obj.children(".workAdd").removeClass("dn"),
                  h.obj.children(".c_add").addClass("dn")),
                $("#lastChangedTime span").text(b.content.refreshTime),
                $("#resumeScore .which div").text(
                  b.content.infoCompleteStatus.msg
                ),
      ...
      h.obj.find(".slist li:last-child").addClass("noborder"),
      h.obj.find(".workAdd").bind("click", function () {
        h.Add();
      }),
      ...
      h.obj.on("keyup", ".s_textarea", function () {
        var a = $(this);
        $.trim(a.val()).length > 100
          ? a.val($.trim(a.val()).substring(0, 100))
          : a
              .next(".word_count")
              .children("span")
              .text(100 - $.trim(a.val()).length);
      }),
      i(),
      $("#resumeSet h2 span").bind("click", function () {
        a = !1;
        var b = $(this).parents("#resumeSet");
        $.ajax({
          url: ctx + "/mycenter/resume/getAllResumes.json",
          type: "GET",
        }).done(function (a) {
          a.success
            ? (a.content[0].isDefault &&
                (b.find(".resume0").click(),
                b.children(".defaultResume").val(a.content[0].type)),
              a.content[1].isDefault &&
                (b.find(".resume1").click(),
                b.children(".defaultResume").val(a.content[1].type),
                a.content[1].perfect ||
                  (b
                    .find(".setTip")
                    .text("")
                    .show(),
                  b.find(".btn_profile_save").attr("disabled", "disabled"))),
              a.content[0].perfect ||
                a.content[1].perfect ||
                (b.find(".setTip").text("").show(),
                b.find(".btn_profile_save").attr("disabled", "disabled")),
              b.children(".noSet").hide(),
              b.children("#resumeSetForm").removeClass("dn"),
              b
                .children("#resumeSetForm")
                .find('input[type="radio"]')
                .bind("click", function () {
                  1 != $(this).val() || a.content[1].perfect
                    ? 0 != $(this).val() || a.content[0].perfect
                      ? (b.find(".setTip").text("").hide(),
                        b.find(".btn_profile_save").removeAttr("disabled"))
                      : (b
                          .find(".setTip")
                          .text("")
                          .show(),
                        b
                          .find(".btn_profile_save")
      ...
      $("#resumeSetForm .btn_profile_cancel").bind("click", function () {
        var b = $(this).parents("#resumeSet"),
          c = b.children(".defaultResume").val();
        -1 == c
          ? (b.children(".noSet").show(),
            b.children(".set0").hide(),
            b.children(".set1").hide(),
            b.children("#resumeSetForm").addClass("dn"))
          : (b.children(".noSet").hide(),
            b.children(".set" + c).show(),
            b.children("#resumeSetForm").addClass("dn")),
          (a = !0);
      }),
      $("#resumeSetForm").validate({
        rules: { resume: { required: !0 } },
        messages: { resume: { required: "" } },
        errorPlacement: function (a, b) {
        ...
        submitHandler: function (b) {
          ...
          $(b).find(":submit").attr("disabled", !0),
            $.ajax({
              ...
              d.success
                ? ((a = !0),
                  $("#resumeSet .noSet").hide(),
                  $("#resumeSet .set" + c).show(),
                  $("#resumeSet .defaultResume").val(c),
                  $("#resumeSetForm").addClass("dn"))
                : alert(d.msg),
      ...
      $("#myResume").on("click", ".resumeUploadDiv a.del", function () {
        confirm("") &&
          $.ajax({ url: ctx + "/nearBy/delNearBy.json", type: "GET" }).done(
            function (a) {
              a.success
                ? ($("#myResume h2 a").html(""),
                  $("#myResume .resumeUploadDiv").html(""))
                : alert(a.msg);
            }
          );
      });
