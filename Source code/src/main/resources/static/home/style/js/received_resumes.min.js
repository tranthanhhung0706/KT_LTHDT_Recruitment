...
function popQR() {
  $.ajax({ url: ctx + "/mycenter/showQRCode", type: "GET" }).done(function (a) {
    a.success &&
      ($("#weixinQR .qr img").attr("src", a.content),
      $.colorbox({
        inline: !0,
        href: $("#weixinQR"),
        title: "",
...
function highlight() {
  ...
  $("#filterForm ul.resumeLists").prepend('<li class="borderHighlight"></li>'),
    $("#filterForm ul.resumeLists li.borderHighlight")
      .css("height", a)
      .fadeIn(400)
      .delay(2500)
      .fadeOut(400);
...
$(function () {
  $("#filter_btn").bind("click", function () {
    ...
    $(".resume_refuse").bind("click", function () {
      ...
      $('#refuseMailForm input[name="deliverId"]').val(a),
        $.ajax({
          ...
          a.success &&
            ($("#refuseMailForm textarea")
              .val(a.content.content)
              .removeClass("error")
              .removeClass("valid"),
    ...
    $(".resume_caninterview").click(function () {
      ...
      $.ajax({
        ...
        $("#resubmitToken").val(a.resubmitToken),
          a.success ? (top.location.href = top.location.href) : alert(a.msg);
      });
    }),
    ...
    $(".resume_forward").bind("click", function () {
      ...
      $(this).children("dl").hide(),
        (a = $(this).attr("data-resumeKey")),
        (b = $(this).attr("data-positionId")),
        (c = $(this).attr("data-deliverId")),
        (d =
          "（）" +
          $(this).attr("data-positionName") +
          "：" +
          $(this).attr("data-resumeName")),
        (e =
          "" +
          $(this).attr("data-positionName") +
          ""),
        $('#forwardResumeForm input[name="resumeKey"]').val(a),
        $('#forwardResumeForm input[name="positionId"]').val(b),
        $('#forwardResumeForm input[name="deliverId"]').val(c),
        $('#forwardResumeForm input[name="title"]')
          .val(d)
          .removeClass("error")
          .removeClass("valid"),
        $('#forwardResumeForm textarea[name="content"]')
          .val(e)
          .removeClass("error")
          .removeClass("valid"),
        ...
        $.ajax({
          ...
          $("#resubmitToken").val(a.resubmitToken),
            a.success
              ...
              : ($("#forwardResumeError").html(a.msg).addClass("error"),
                $("#forwardResumeForm .beError").html(a.msg).show());
        });
      },
    }),
    $(".resume_notice").bind("click", function () {
      ...
      $.ajax({
        ...
        a.success
          ? ($("#receiveEmail").text(a.content.email),
            $('#noticeInterview input[name="email"]').val(a.content.email),
            $('#noticeInterview input[name="name"]').val(a.content.name),
            $('#noticeInterview input[name="subject"]')
              .val(a.content.subject)
              .removeClass("error")
              .removeClass("valid"),
            $('#noticeInterview input[name="interAdd"]')
              .val(a.content.interAdd)
              .removeClass("error")
              .removeClass("valid"),
            $('#noticeInterview input[name="linkPhone"]')
              .val(a.content.linkPhone)
              .removeClass("error")
              .removeClass("valid"),
            $('#noticeInterview input[name="linkMan"]').val(a.content.linkMan),
            $('#noticeInterview textarea[name="content"]').val(
              a.content.content
            ),
            $('#noticeInterview input[name="positionName"]').val(
              a.content.positionName
            ),
            $('#noticeInterview input[name="companyName"]').val(
              a.content.companyName
            ),
            $('#noticeInterview input[name="deliverId"]').val(d),
            $("#noticeInterview span.error").remove(),
            $.colorbox({
              inline: !0,
    ...
    $("#noticeInterview .emailPreview").bind("click", function () {
      var j,
        k,
        a = $('#noticeInterviewForm input[name="name"]').val(),
      ...
      (h = h.replace("/\r\n/g", "<br>")),
        ...
        (k = !1),
        ("" == c ||
          $('#noticeInterviewForm input[name="subject"]').hasClass("error")) &&
          (k = !0),
        ("" == d ||
          $('#noticeInterviewForm input[name="interTime"]').hasClass(
            "error"
          )) &&
          (k = !0),
        ("" == e ||
          $('#noticeInterviewForm input[name="interAdd"]').hasClass("error")) &&
          (k = !0),
        ("" == g ||
          $('#noticeInterviewForm input[name="linkPhone"]').hasClass(
            "error"
          )) &&
          (k = !0),
        $('#noticeInterviewForm textarea[name="content"]').hasClass("error") &&
          (k = !0),
        k
    ...
    $("#colorbox").on("click", "#cboxClose", function () {
      "forwardResumeSuccess" ==
        $(this).siblings("#cboxLoadedContent").children("div").attr("id") &&
        (top.location.href = top.location.href);
    }),
    $(
      "#forwardResumeSuccess .btn,#noticeInterviewSuccess .btn,#refuseMailSuccess .btn"
    ).bind("click", function () {
      top.location.href = top.location.href;
    }),
    ...
    $("#weixinQR .btn_s,#weixinQR .qr_cancel").click(function () {
      var a = new Date();
      $.cookie("showQRCode", a.getDate(), { expired: 180 }),
        $.colorbox.close(),
        parent.jQuery.colorbox.close();
    }),
    $(".resumeLists li a.resumeImg").bind("click", function () {
      $(this)
        .siblings(".resumeIntro")
        .children("h3")
        .removeClass("unread")
        .addClass("read");
    }),
    ...
    $(".resumeLists li .links a.resume_forward").hover(
      function () {
        var a = $(this),
